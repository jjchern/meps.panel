...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/jjchern/meps.panel?branch=master&svg=true)](https://ci.appveyor.com/project/jjchern/meps.panel)
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/meps.panel)](https://cran.r-project.org/package=meps.panel)

The goal of `meps.panel` is to wrap the two-year panel files from the 
...
Currently the package includes data from panel 16 (2011-2012), panel 17 
(year 2012-2013), and panel 18 (year 2013-2014). The rest of the panel files 
